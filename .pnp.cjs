...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState(JSON.parse('{\
    ...
    "dependencyTreeRoots": [\
      ...
      {\
        "name": "@svcs/compute",\
        "reference": "workspace:svcs/compute"\
      },\
      {\
        "name": "nodeEV",\
    ...
    "packageRegistryData": [\
      ...
      ["@pkgs/allocator", [\
        ["workspace:pkgs/allocator", {\
          "packageLocation": "./pkgs/allocator/",\
          "packageDependencies": [\
            ["@pkgs/allocator", "workspace:pkgs/allocator"]\
          ],\
          "linkType": "SOFT"\
      ...
      ["@pkgs/io_uring", [\
        ["workspace:pkgs/io_uring", {\
          "packageLocation": "./pkgs/io_uring/",\
          "packageDependencies": [\
            ["@pkgs/io_uring", "workspace:pkgs/io_uring"]\
          ],\
          "linkType": "SOFT"\
